...
class selfMenu(ShowBase):
    ...
    def move(self, task):
        ...
        self.collisionevent('firstline',-5,-80,10)
        
        self.collisionevent('secondline',-70,-10,20)

        self.collisionevent('thirdline',-10,115, 10)
        
        self.collisionevent('fourthline',55,-10,10)
    ...
    def collisionevent(self,name,startx,starty,iterations):
        xnames=["firstline","thirdline","fifthline","seventhline"]
        ynames=["secondline","fourthline","sixthline","eighthline"]
        levelnames=['firstline','secondline','thirdline','fourthline']
        ...
        ralphcoor= [int(self.ralph.getX()),int(self.ralph.getY())]
        #print(ralphcoor)
        if (ralphcoor in coorlist):
    ...
    def secondWindow(self,name):
        ...
        if name=='firstline':
            print("") #pygame code level one
        
        if name=='secondline':
            print("") #pygame code level two
        
        if name=='thirdline':
            print("") #pygame code level three
    ...
    def newScreen(self):
        ...
        # Set up the camera
        self.disableMouse()
        self.camera.setPos(self.ralph.getX(), self.ralph.getY()+10, self.ralph.getZ()+2)
        ...
        # Add the Title
        self.title = self.addTitle("Tile: The description will be here")
        # Post the instructions
        self.inst1 = self.addInstructions(0.06, "[ESC]: Quit")
        self.inst2 = self.addInstructions(0.12, "[Left Arrow]: Rotate self Left")
        self.inst3 = self.addInstructions(0.18, "[Right Arrow]: Rotate self Right")
